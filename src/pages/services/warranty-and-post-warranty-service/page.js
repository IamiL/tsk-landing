        ...
        <section className={styles.serviceSection}>
            ...
            <div>
                ...
                <div className='fs5 mfs6 i-r'>
                    <p>Клиенты компании «тСк» получают квалифицированную помощь на протяжении всего срока эксплуатации
                        приобретенного оборудования. Мы осуществляем регулярное профилактическое обслуживание, устраняем
                        неисправности и производим модернизацию ранее смонтированной аппаратуры.</p>
                    <br/>
                    <p>Наши специалисты регулярно проходят повышение квалификации и знают обо всех новшествах рынка
                        оборудования и программного обеспечения. Обращаясь к нам, вы получаете гарантию стабильности и
                        бесперебойной работы ваших систем безопасности и автоматизации.</p>
                    <br/>
                    ...
                    <br/>
                    <p>Сотрудничество с компанией «тСк» позволяет вам надежно защитить ваш объект, оптимизировать
