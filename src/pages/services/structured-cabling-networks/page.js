            ...
            <div>
                ...
                <div className='fs5 mfs6 i-r'>
                    <p>Высококачественная кабельная инфраструктура необходима для стабильной работы всей информационной
                        инфраструктуры предприятия. Специалисты компании «тСк» занимаются созданием структурированных
                        кабельных сетей (СКС), позволяющих объединить различные подсистемы коммуникаций в единую
                        сеть.</p>
                    <br/>
                    <p>Это способствует повышению эффективности обмена информацией между подразделениями, снижению
                        количества сбоев и увеличению скорости обработки данных. Кабельная инфраструктура, созданная
                        нашими специалистами, обеспечит вашему предприятию устойчивый рост и развитие бизнеса.</p>
                    <br/>
