            ...
            <div>
                ...
                <div className='fs5 mfs6 i-r'>
                    <p>Компания «тСк» предлагает комплексные решения по обеспечению безопасности вашего предприятия,
                        ...
                        безопасности.</p>
                    <p>Мы используем современное оборудование ведущих производителей, обеспечивающее высокий уровень
                    ...
                    <p>Услуга включает установку видеонаблюдения, контроль доступа, охранно-пожарную сигнализацию и
