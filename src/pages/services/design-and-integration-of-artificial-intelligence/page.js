            ...
            <div>
                ...
                <div className='fs5 mfs6 i-r'>
                    <p>Искусственный интеллект открывает новые горизонты для оптимизации бизнес-процессов предприятий
                        любой отрасли. Специалисты компании «тСк» создают внедряют инновационные IT-решения на основе
                        последних достижений науки и техники.</p>
                    <br/>
                    <p>Мы применяем технологии машинного обучения и компьютерного зрения для автоматизации производства,
                        улучшения контроля качества продукции и снижения затрат на рутинные операции. Современные
                        алгоритмы аналитики помогают быстро выявлять аномалии, повышать эффективность труда и улучшать
                        показатели деятельности предприятия.</p>
                    <br/>
