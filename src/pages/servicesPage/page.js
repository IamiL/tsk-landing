        ...
        <section id='servicesp-sec'>
            ...
            <div id='servicesp-container1'>
                ...
                <p id='servicesp-container1-text'
                   className='fs5 mfs6 i-r'>Мы предлагаем комплексный подход к решению задач, поставленных заказчиком,
                    обеспечивая создание надежной и эффективной системы безопасности. В её состав входят подсистемы
                    видеонаблюдения, контроля доступа и охранной сигнализации.<br/>
